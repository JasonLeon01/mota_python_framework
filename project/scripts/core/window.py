...
class Window(Surface):
    ...
    def __render_back(self):
        ...
        self.__content_surface.clear()
        if self.__content_surface.get_size() != (self._size[0] - 32, self._size[1] - 32):
            self.__content_surface = Surface((self._size[0] - 32, self._size[1] - 32))
        row_surface = self.__window_back.copy()
        row_surface.blit(pygame.transform.scale(pygame.Surface.subsurface(self.asset, (0, 0, 128, 128)), (self._size[0] - 2, self._size[1] - 2)), (1, 1))
        row_surface.set_alpha(self.back_opacity)
        self.__window_back.blit(row_surface, self.__window_back.get_rect())
        self.__render_corner(self.__cached_corner['window'], [(0, 0), (self._size[0] - 16, 0), (0, self._size[1] - 16), (self._size[0] - 16, self._size[1] - 16)], self.__window_back)
        self.__render_edge([(144, 0, 32, 16), (144, 48, 32, 16), (128, 16, 16, 32), (176, 16, 16, 32)], [(self._size[0] - 32, 16), (self._size[0] - 32, 16), (16, self._size[1] - 32), (16, self._size[1] - 32)], [(16, 0), (16, self._size[1] - 16), (0, 16), (self._size[0] - 16, 16)], self.__window_back)
    ...
    def __render_rect(self, rect, dst):
        ...
        draw_surface.set_alpha(120 + 5 * abs(27 - self.__render_count % 54))
